...
*  Choose from five sleek new login-page designs
...
= 1.2 =
New: Free users - Create a password hint to remind your website visitors what the password is. Premium users - you can now choose from 6 sleek designs for the login page, add a custom background image, custom CSS, and even create your own login page templates within your theme folder.